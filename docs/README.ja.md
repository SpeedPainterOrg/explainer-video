...
[![自動生成された Explainer Video の手描きアニメーション](../assets/explainer-video-demo-preview.gif)](../assets/explainer-video-demo.mp4)

[ナレーションと焼き込み字幕付きの 20 秒デモを見る。](../assets/explainer-video-demo.mp4)
